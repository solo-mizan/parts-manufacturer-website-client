    ...
    return (
        <section class="bg-white dark:bg-gray-900">
            <div class="container px-6 py-10 mx-auto">
                <h1 class="text-3xl font-semibold text-center text-gray-800 capitalize lg:text-4xl dark:text-white">explore our <br /> awesome <span class="text-blue-500">Business Policy</span></h1>
                ...
                <div class="grid grid-cols-1 gap-8 mt-8 xl:mt-12 xl:gap-16 md:grid-cols-2 xl:grid-cols-3">
                    <div class="flex flex-col items-center p-6 space-y-3 text-center bg-gray-100 rounded-xl dark:bg-gray-800">
                        ...
                        <h1 class="text-2xl font-semibold text-gray-700 capitalize dark:text-white">3 Days Shipping</h1>
                    ...
                    <div class="flex flex-col items-center p-6 space-y-3 text-center bg-gray-100 rounded-xl dark:bg-gray-800">
                        ...
                        <h1 class="text-2xl font-semibold text-gray-700 capitalize dark:text-white">15 Days Moneyback Gurantee</h1>
                    ...
                    <div class="flex flex-col items-center p-6 space-y-3 text-center bg-gray-100 rounded-xl dark:bg-gray-800">
                        ...
                        <h1 class="text-2xl font-semibold text-gray-700 capitalize dark:text-white">24/7 Customer Service</h1>
